<aside class="left-sidebar" data-sidebarbg="skin6" style="box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;">
            <!-- Sidebar scroll-->
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item">
							<a class="sidebar-link sidebar-link" href="index.php?page=dashboard" aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                <li class="sidebar-item">
									<a href="category.php?page=category" class="sidebar-link">
										<span class="hide-menu">
											Category
                                        </span>
									</a>
