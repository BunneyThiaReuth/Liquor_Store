          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">List Import</h4>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="modal-dialog modal-dialog" role="document">
	...
	Are you sure to dalete this record ?
      ...
      <div class="modal-footer">
		  <a href="listimp.php?page=listimp&action=3&delid=<?=$getrows['impID']?>" class="btn btn-primary w-25">Yes</a>
...
<div class="modal fade" id="editModalCenter<?=$getrows['impID']?>" tabindex="-1" role="dialog" aria-labelledby="editModalCenter<?=$getrows['impID']?>" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content alert-warning">
      ...
      <div class="modal-body">
		<form method="post" enctype="multipart/form-data" action="listimp.php?page=listimp&action=2">
...
<script>
    ...
    if (window.history.replaceState ) {
         window.history.replaceState( null, null, "listimp.php?page=listimp");  
    }
</script>
</script>
</body>
